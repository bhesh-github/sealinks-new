  ...
  return (
    <div className="contents-column">
      ...
      <div className="contents-wrapper">
        ...
        /> */}
        <div className="htmls">
          <h2> Discover Our Comprehensive Medical Program </h2>
          <br />
          <img
          ...
          >
            At NMC, we are committed to providing exceptional healthcare
            services to our community. Our comprehensive Medical Program is
            designed to meet the diverse healthcare needs of our patients while
          ...
          >
            Our Medical Program encompasses a wide range of healthcare services,
            from preventive care and routine check-ups to specialized treatments
            and chronic disease management. We are dedicated to delivering
            compassionate and personalized care that focuses on the well-being
            of our patients.
          </div>
          <br />
          <br />
          ...
          >
            ...
            >
              <li>
                Experienced and caring primary care physicians for all ages.
              </li>
              <br />
              <li>
                Routine check-ups, vaccinations, and preventive screenings.
              </li>
              <br />
              <li>
                Diagnosis and management of common illnesses and conditions.
              </li>
              <br />
            </ul>
            <br />
            <div>2. Specialized Care:</div>
            <br />
            <ul
              style={{
                marginLeft: "2em",
            ...
            >
              <li>
                Access to a network of specialists in various medical fields.
              </li>
              <br />
              <li>Advanced diagnostic tools and treatment options.</li>
              <br />
              <li>Comprehensive care for complex medical conditions.</li>
              <br />
            </ul>
            <br />
            <div>3. SChronic Disease Management:</div>
            <br />
            <ul
              style={{
                marginLeft: "2em",
            ...
            >
              <li>
                Personalized treatment plans for patients with chronic
                illnesses.
              </li>
              <br />
              <li>Education and support for better disease management.</li>
              <br />
              <li>Regular monitoring to improve quality of life.</li>
              <br />
            </ul>
            <br />
            <div>4. Women's Health:</div>
            <br />
            <ul
              style={{
                marginLeft: "2em",
            ...
            >
              <li>
                Comprehensive women's health services, including obstetrics and
                gynecology.
              </li>
              <br />
              <li>Prenatal care, family planning, and menopause management.</li>
              <br />
            </ul>
            <div>5. Pediatric Care:</div>
            <br />
            <ul
              style={{
                marginLeft: "2em",
            ...
            >
              <li>
                Expert pediatricians for the health and well-being of your
                children.
              </li>
              <br />
              <li>
                Immunizations, growth monitoring, and developmental assessments.
              </li>
              <br />
            </ul>
            <br />
            <div>6. Geriatric Care:</div>
            <br />
            <ul
              style={{
                marginLeft: "2em",
            ...
            >
              <li>Specialized care for our elderly patients.</li>
              <br />
              <li>
                Geriatric assessments, medication management, and fall
                prevention.
              </li>
              <br />
            </ul>
            <br />
            <div>
              <h3>Why Choose Our Medical Program:</h3>
              <br />
              <ul>
                <li>
                  <strong>Experienced Physicians:</strong>
                  Our team of skilled and compassionate healthcare providers is
                  dedicated to your health and well-being.
                </li>
                <br />
                <li>
                  <strong>Patient-Centered Care:</strong>
                  We prioritize your needs, preferences, and comfort in every
                  aspect of your healthcare journey.
                </li>
                <br />
                <li>
                  <strong>State-of-the-Art Facilities: </strong>
                  Our modern medical facilities are equipped with advanced
                  technology to ensure accurate diagnosis and effective
                  treatment.
                </li>
                <br />
                <li>
                  <strong>Collaborative Approach: </strong>
                  Our healthcare professionals work together as a team to
                  provide comprehensive care tailored to your unique health
                  needs.
                </li>
                <br />
                <li>
                  <strong>Convenient Scheduling: </strong>
                  We offer flexible scheduling options, including same-day
                  appointments for urgent healthcare needs.
                </li>
                <br />
                <li>
                  <strong>Community Engagement: </strong>
                  We actively engage with our community through health education
