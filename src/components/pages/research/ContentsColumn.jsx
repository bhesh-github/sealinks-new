        ...
        <div className="htmls" style={{ width: "100%", textAlign: "justify" }}>
          <div className="html-wrapper">
            ...
            <div className="desc">
              ...
              doing the same for its faculty members and this is one of such
              kind. Nepal Medical College is running Medical, Dental and Nursing
              academic programs with respective faculty members. Though the
              programs differ from one another, the process involved in
              educating medical, dental and nursing students (learners) remain
              more or less the same. In this context, the workshop intends to
              allow faculty members belonging to different health professions
              share the same forum and discuss on spectrum of academic issues to
              foster "HealthCare Team" spirit and "Facilitate Learning for
              Quality Assurance".
            </div>
          </div>
          <br />
          ...
          <div className="html-wrapper">
            ...
            <ul style={{ marginLeft: "1em" }} className="desc list-desc">
              ...
              <li>
                Describe the methods of helping learners acquire knowledge
              </li>
              <li>Plan Lesson</li>
              ...
              <li>
                Select Audio Visual Aids and utelise for making learning
                effective
              </li>
