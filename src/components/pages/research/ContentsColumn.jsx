    ...
    <div className="right-column">
      ...
      <div className="htmls" style={{ width: "100%", textAlign: "justify" }}>
        <div className="html-wrapper">
          ...
          <br />
          <div className="desc">
            Teacher Training Workshops for the faculty members (facilitators)
            are held in Nepal by different Universities, medical schools,
            medical institutes and medical colleges from time to time. Nepal
            Medical College, affiliated to Kathmandu University, has also been
            doing the same for its faculty members and this is one of such kind.
            Nepal Medical College is running Medical, Dental and Nursing
            academic programs with respective faculty members. Though the
            programs differ from one another, the process involved in educating
            medical, dental and nursing students (learners) remain more or less
            the same. In this context, the workshop intends to allow faculty
            members belonging to different health professions share the same
            forum and discuss on spectrum of academic issues to foster
            "HealthCare Team" spirit and "Facilitate Learning for Quality
            Assurance".
          </div>
        </div>
        <br />
        <div className="html-wrapper">
          ...
          <br />
          <div className="desc">
            Medical Education Department (MED) has a firm belief that the
            Workshop must be held in a non-formal working environment for
            allowing maximum interactions among participants and resource
            persons. However, the workshop, as any where else, demands
            punctuality and regularity with full time participation which help
            achieve the outcome of the workshop.
          </div>
        </div>
        <br />
        <div className="html-wrapper">
          <h3 className="heading">Workshop Objectives</h3>
          <br />
          <div>
          ...
          <ul style={{ marginLeft: "1em" }} className="desc list-desc">
            ...
            <li>
              Comprehend how learner can be motivated to develop right kind of
              attitude required of medical profession
            </li>
            <li>Design and demonstrate microteaching</li>
            <li>
              Select Audio Visual Aids and utelise for making learning effective
            </li>
            <li>List roles and Responsibilities of facilitator</li>
            <li>Comprehend the concept of Problem-Based Learning (PBL)</li>
            <li>
              Determine how PBL is implemented through Small Group Learning
            </li>
            <li>Demonstrate Communication Skills</li>
            <li>
              Distinguish purposes of Assessments and construct Tools for
              Assessment of Knowledge / Skills / Attitude of learners
            </li>
          </ul>
        </div>
        <br />
        <div className="html-wrapper">
          ...
          <br />
          <div className="desc">Facilitate learning for quality assurance</div>
        </div>
        <br />
      </div>
    </div>
